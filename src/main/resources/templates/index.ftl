...
<html>
    <head>
        ...
        <style>
            ...
            .category {position:absolute;overflow:hidden;top:10px;left:80px;width:300px;height:50px;z-index:10;border:1px solid black;font-family:'Malgun Gothic','맑은 고딕',sans-serif;font-size:12px;text-align:center;background-color:#fff;}
...
<div id="mapwrap">
    ...
    <div class="category">
        <ul>
            <li onclick="getCurrentLocation()">
                <img src="./img/location.png" style="display:block;margin:0 auto 2px;width:22px;height:26px;">
                현위치
            </li>
